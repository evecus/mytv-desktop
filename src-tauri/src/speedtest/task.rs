use crate::speedtest::channel::{
    build_m3u8_entry, clean_channel_name, get_standard_channel_map, map_to_standard_name,
};
use crate::speedtest::config::{API_URL, HSMD_ADDRESS_LIST_FILE, SPEED_LOW};
use crate::speedtest::output::build_and_write;
use crate::speedtest::speedtest::{fetch_channels_for_source, run_api_speed_tests, test_subscribe_hosts};
use crate::speedtest::subscribe::{download_subscribes, host_key, parse_subscribe_file};
use crate::speedtest::types::{Entry, SourceResult};
...
fn build_entries(
    channels: &[crate::speedtest::types::Channel],
    idx: usize,
    speed: f64,
